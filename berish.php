...
<div class="p-3" style="background-color: rgba(239,243,239,0.66); box-shadow: 0px 0px 20px 20px #dad7ea; border-style: solid;border 30px; border-color:  #7009ef; border-radius: 20px; width: 400px; height: 530px; margin: 10px auto">
    <form action="" method="post">
        ...
        <div class="mb-3">
            <label style="color:#7009ef; font-weight: 700; font-size: 16px; " for="exampleInputPassword1" class="form-label">Berilayotgan qarz</label>
        ...
        <br>
        <input style=" font-weight: 700; font-size: 16px; " type="submit" name="submit" class="form-control btn btn-outline-success" value="Berish">
    </form>
</div>
